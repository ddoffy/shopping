...
func (_m *ProductRepository) Delete(ctx context.Context, id int) (bool, error) {
...
func (_m *ProductRepository) Fetch(ctx context.Context) ([]*model.Product, error) {
	ret := _m.Called(ctx)
...
// FetchProductWithQuery provides a mock function with given fields: ctx, query
func (_m *ProductRepository) FetchProductWithQuery(ctx context.Context, query string) ([]*model.Product, error) {
...
func (_m *ProductRepository) Store(ctx context.Context, a *model.Product) (int64, error) {
	ret := _m.Called(ctx, a)
